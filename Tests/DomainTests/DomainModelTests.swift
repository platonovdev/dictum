...
func defaultSettingsFavorLocalAutopasteFlow() {
    ...
    #expect(AppSettings.default.positionOverlayNearCaret)
    #expect(AppSettings.default.pauseMediaDuringRecording)
...
func settingsDecodeSafelyFromThePreviousSchema() throws {
    ...
    #expect(settings.positionOverlayNearCaret)
    #expect(settings.pauseMediaDuringRecording)
